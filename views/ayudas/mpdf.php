...
<img src="/img/cabecera.png" alt="La Rioja - Argentina">
    <h2 style="text-align: center;color:#0078CF;">Consulta General</h2>
    <h3 style="text-align: left;color:#0025FA;"> <?php echo "Filtrado por:"?></h3>
    <?php if ($_GET['inputdni']!= NULL) {?>
    <p style="text-align: left;"> <?php echo "DNI: ".$_GET['inputdni']?></p>
    <?php }?>
    <?php if ($_GET['inputtipoayuda']!= NULL){

        $idtipo= $_GET['inputtipoayuda'];
      ...
      ?>
    <p style="text-align: left;"> <?php echo "Tipo de Ayuda: ".$nombretipo?></p>
    <?php }?>
    <?php if ($_GET['inputestado']!= NULL){
        $idestado= $_GET['inputestado'];
        ...
        ?>
    <p style="text-align: left;"> <?php echo "Estado: ".$nombreestado?></p>
    <?php }?>
    <?php if ($_GET['inputmonto']!= NULL) {?>
    <p style="text-align: left;"> <?php echo "Monto: $".$_GET['inputmonto']?></p>
    <?php }?>
    <?php if ($_GET['inputarea']!= NULL) {?>
    <p style="text-align: left;"> <?php echo "Área: ".$_GET['inputarea']?></p>
    <?php }?>
    <br>
    <?= GridView::widget([
