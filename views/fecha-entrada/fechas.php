...
$this->title = 'Consulta por Fecha de Entrada';
...
<div class="ayudas-index">
    ...
    <?= Html::a('Realizar nueva consulta', ['/fecha-entrada/fecha_entrada'], ['class' => 'btn btn-success']) ?>
...
<script>
      btnPDF = document.getElementById('btn-pdf');
          inputCodigo = document.getElementsByClassName('form-control')[7];
          btnPDF.addEventListener('click', function() {
              var searchParams = new URLSearchParams(window.location.search);
              searchParams.set('r','fecha-entrada/mpdffecha_entrada')
              searchParams.set('inputfecha_entrada', inputCodigo.value)
