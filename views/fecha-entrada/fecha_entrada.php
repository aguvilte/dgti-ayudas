...
<div class="ayudas-index">
    ...
    <div class="body-content">
        <div class="row">
            <?php  echo $this->render('_searchfecha_entrada', ['model' => $searchModel]); ?>
        </div>
    </div>
...
<script>
inputFecha = document.getElementById('ayudassearch-fecha_entrada');
...
form.addEventListener('submit', function() {
    ...
    document.getElementById('ayudassearch-fecha_entrada').value = newdate;
